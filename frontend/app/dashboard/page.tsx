...
import { Ticket, Clock, AlertTriangle, CheckCircle2, ArrowUpRight, Loader2, Eye, Bell } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
        {[
          ...
          { label: 'Watching', value: data?.watchingCount || 0, icon: Eye, color: 'text-purple-400' },
        ...
        <div className="bg-card border border-border rounded-2xl p-5">
          ...
          <div className="space-y-3">
            {data?.byPriority?.map((p: any) => {
              const total = data?.byPriority?.reduce((sum: number, x: any) => sum + x._count, 0) || 1;
              return (
